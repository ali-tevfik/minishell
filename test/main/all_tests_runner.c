...
/*   Updated: 2022/03/01 11:53:14 by hyilmaz       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
TEST_GROUP_RUNNER(CreateParseList)
{
	...
	RUN_TEST_CASE(CreateParseList, PipelineWithExpansion0);
	RUN_TEST_CASE(CreateParseList, PipelineWithExpansion1);
}
