...
/*   Updated: 2022/01/23 12:38:31 by hyilmaz       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "validate_grammer.h"

static void	print_unexpected_token_message(t_token *token)
{
...
bool	validate_grammer(t_list *token_list)
{
	...
	while (head)
	{
		...
		{
			print_unexpected_token_message((t_token *)(head->content));
			return (false);
		}
